...
public class Test6 {
	public void say() throws IOException{
		File file=new File("E:"+File.separator+"test"+File.separator
				+"test.txt"); 
		...
		int i=0;//i表示除数
		int t=0;//t表示被除数
		if(scanner.hasNextInt()){//i,t进行整数判断
		...
		int a=list.get(list.size()-1);//a表示求出数中的最大值
		int b=list.get(0);//b表示求出数中的最小值
